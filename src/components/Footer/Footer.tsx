        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <div className="flex flex-row justify-center items-center gap-10">
              {/* Social links... */}
              <a href="https://www.instagram.com"><Image src="/Footer/instagram.svg" alt="Instagram" width={36} height={36} /></a>
              <a href="https://www.facebook.com"><Image src="/Footer/facebook.svg" alt="facebook" width={36} height={36} /></a>
              <a href="https://www.youtube.com"><Image src="/Footer/youtube.svg" alt="youtube" width={36} height={36} /></a>
              <a href="https://www.linkedin.com"><Image src="/Footer/linkedin.svg" alt="linkedin" width={36} height={36} /></a>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <div className="flex flex-col justify-center md:items-start items-center gap-6 ">
              <h3 className="text-[clamp(18px,2.5vw,28px)] text-[#7E5005] font-[600] ">{t('getAccess')}</h3>
              <form action="">
                <input
                  type="email"
                  id="newsletter"
      ...
      <div className="section-width mx-auto px-6 !my-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col justify-center md:items-start items-center gap-4">
            ...
            <h3 className="text-[#7E5005] text-[clamp(16px,2vw,24px)] font-[600] max-w-[500px] text-center md:text-start">{t('tagline')}</h3>
          </div>
          <div className="flex flex-col justify-center items-start gap-4 text-[#7E5005] text-[clamp(16px,2vw,24px)] font-[600] max-w-[500px]">
            <Link href={`/${locale}`}>{t('terms')}</Link>
            <Link href={`/${locale}`}>{t('privacy')}</Link>
            <Link href={`/${locale}/parentguide`}>{t('parentGuide')}</Link>
          </div>
        </div>
